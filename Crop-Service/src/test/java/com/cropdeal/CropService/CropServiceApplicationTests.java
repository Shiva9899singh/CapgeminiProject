...
class CropServiceApplicationTests {
	...
	public void getCropTest() {
		when(croprepo.findAll()).thenReturn(Stream
				.of(new Crop("123","abcd","abc@123","34567889", null, null, null),new Crop("321","cba","cba@321","34567889", null, null, null)).collect(Collectors.toList()));
