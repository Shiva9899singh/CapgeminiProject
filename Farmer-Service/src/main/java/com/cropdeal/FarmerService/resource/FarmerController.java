...
//-------------------------------------------Curd Operations----------------------------------------
	...
	public String addfarmer(@RequestBody Farmers farmer) {
		farmerRepo.save(farmer);
		return "Added farmer with id " + farmer.getId();
	}

	@GetMapping("/findfarmer")
	public List<Farmers> getfarmer() {
		return farmerRepo.findAll();
	}

	// get book base on id
	@GetMapping("/findfarmer/{id}")
	public Optional<Farmers> getfarmer(@PathVariable String id) {
		return farmerRepo.findById(id);
	}

	@PutMapping("/farmer/update/{id}")
	public void updateFarmer(@RequestBody Farmers farmer, @PathVariable("id") String id) {
	...
	@GetMapping("/farmer")
	public List<Farmers> getFarmeratAdmin() {
		Farmers[] farmer = restTemp.getForObject("http://farmer-service/api/findfarmer", Farmers[].class);
